...
tar.exe -a -c -f .\release\dsh-sandbox-escalation-fix-release.zip -C .\release dsh-sandbox-escalation-fix-*.tgz install-release.ps1 uninstall-release.ps1 RELEASE-USAGE.zh.md
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
