...
3. 确认 DSH 版本为 `0.1.0-rc.5`、`0.1.0-rc.6`、`0.1.0-rc.7`、`0.1.0-rc.8`、`0.1.1-rc.1` 或 `0.1.1-rc.2`。

> DSH rc8、`0.1.1-rc.1` 和 `0.1.1-rc.2` 仍未消除静态升级 Schema 的根因。建议仅在实际遇到同模式升级、空 justification 或反复重试问题后安装本插件。
